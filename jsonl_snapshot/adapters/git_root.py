#!/usr/bin/env python3
# ==============================================================================
# adapters/git_root.py - git repository root discovery for jsonl_snapshot
# ==============================================================================
...
def find_git_root(start: Optional[Path] = None) -> Path:
    ...
    See session_snapshot/adapters/git_root.py for the full docstring;
    the implementation is duplicated here so jsonl_snapshot remains a
    self-contained package that can be used independently.
    """
    if start is None:
        start = Path.cwd()
    try:
